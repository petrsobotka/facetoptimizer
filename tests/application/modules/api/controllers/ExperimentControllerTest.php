...
class Api_ExperimentControllerTest
	extends ControllerTestCase
{
	
	public function testShouldTriggerAppropriateControllerAndAction()
	{
		$this->dispatch('/api/experiment');
		$this->assertModule('api');
		$this->assertController('experiment');
	...
	{
		$this->request->setMethod('POST');
		$this->getRequest()->setRawBody('<?xml version="1.0" encoding="utf-8"?><facetOptimizer><experiment><name>Pokus</name><url>http://www.ahoj.cz</url><description>popis</description></experiment></facetOptimizer>');
		$this->dispatch('/api/experiment');
	...
	public function testPostRequestShouldReturnErrorWhenBadApiKeyAndSignatureProvided()
	{
		$this->request->setMethod('POST');
		$this->getRequest()->setRawBody('<?xml version="1.0" encoding="utf-8"?><facetOptimizer><experiment><name>Pokus</name><url>http://www.ahoj.cz</url><description>popis</description></experiment></facetOptimizer>');
		$this->dispatch('/api/experiment?apiKey=a&signature=b');
	...
	{
		$this->request->setMethod('DELETE');
		$this->dispatch('/api/experiment?id=654578634534');
