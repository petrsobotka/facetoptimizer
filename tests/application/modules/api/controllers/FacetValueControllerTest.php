...
class Api_FacetValueControllerTest
	extends ControllerTestCase
{
	
	public function testShouldTriggerAppropriateControllerAndAction()
	{
		$this->dispatch('/api/facet-value');
		$this->assertModule('api');
		$this->assertController('facet-value');
	...
	public function testPostRequestShouldReturnErrorWhenUnsupportedAcceptHeaderProvided()
	{
		...
		$this->getRequest()->setRawBody('<?xml version="1.0" encoding="utf-8"?><facet-valueOptimizer></facet-valueOptimizer>');
		$this->dispatch('/api/facet-value');
	...
	{
		$this->request->setMethod('POST');
		$this->getRequest()->setRawBody('<?xml version="1.0" encoding="utf-8"?><facet-valueOptimizer><facet-value><experimentId>5</experimentId><externalId>52</externalId><name>Materiál</name><static>0</static></facet-value></facet-valueOptimizer>');
		$this->dispatch('/api/facet-value');
	...
	public function testPostRequestShouldReturnErrorWhenBadApiKeyAndSignatureProvided()
	{
		$this->request->setMethod('POST');
		$this->getRequest()->setRawBody('<?xml version="1.0" encoding="utf-8"?><facet-valueOptimizer><facet-value><experimentId>5</experimentId><externalId>52</externalId><name>Materiál</name><static>0</static></facet-value></facet-valueOptimizer>');
		$this->dispatch('/api/facet-value?apiKey=a&signature=b');
	...
	{
		$this->request->setMethod('DELETE');
		$this->dispatch('/api/facet-value?id=654578634534');
